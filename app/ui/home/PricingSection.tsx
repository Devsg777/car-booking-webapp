            ...
            <div className="flex flex-col  space-y-10">
                <div className="flex gap-10 flex-col items-center">
                    <div className="text-center max-w-2xl">
                        <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-200 md:text-4xl xl:text-5xl leading-tight">Pricing Plans</h2>
                    </div>
                    <div className="min-w-max flex justify-center md:justify-end">
                        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg shadow-gray-200/40 dark:shadow-none flex items-center relative p-1">
                            <button className="text-white flex items-center h-9 w-max px-4 rounded-lg bg-emerald-500 hover:bg-emerald-600  dark:bg-emerald-400">
                                Airport Taxi
                            </button>
                ...
                <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10 mx-auto">
                    <div className="rounded-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 p-6 sm:p-10 space-y-6">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">+Toll Charge</span>
                        </div>
                        <div className="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-100 dark:before:bg-gray-900" />
                        <div className="flex justify-center">
                            <a href="#" className="outline-none w-max flex items-center mx-auto h-11 px-5 rounded-md bg-gray-100 dark:bg-gray-900 text-emerald-500 dark:text-gray-300">
                                Get Started
                            </a>
                        </div>
                    </div>
                    <div className="rounded-lg relative border border-gray-100 dark:border-gray-900 bg-gray-100 dark:bg-gray-900 p-6 sm:p-10">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="text-center space-y-2">
                                ...
                                <span className="text-gray-700 dark:text-gray-300">+Toll  & Parking</span>
                            </div>
                            <div className="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-200 dark:before:bg-gray-800" />
                            <div className="flex justify-center">
                                <Link href="#" className="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-emerald-500 dark:bg-emerald-400 text-white">
                                    Get Raid
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="rounded-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 p-6 sm:p-10 space-y-6">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">+Toll Charges</span>
                        </div>
                        <div className="flex relative py-3 before:absolute before:top-1/2 before:inset-0 before:h-px before:bg-gray-100 dark:before:bg-gray-900" />
                        <div className="flex justify-center">
                            <Link href="#" className="outline-none w-max mx-auto flex items-center h-11 px-5 rounded-md bg-gray-100 dark:bg-gray-900 text-emerald-500 dark:text-gray-300">
                                Get Started
                            </Link>
                        </div>
                    </div>
