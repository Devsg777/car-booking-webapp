                ...
                <div className="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                    <div className="lg:py-6">
                        <div className="text-center lg:text-left">
                            ...
                            Easy. Reliable. Green <Link href="#" className="underline text-emerald-700 dark:text-white font-semibold">Get here</Link>
                            </span>
                            <h1 className="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-br from-emerald-500 to-[#8cd66a]">
                                    SDM e-mobility Services
                                </span>

                            </h1>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300 mt-8 text-center lg:text-left mx-auto max-w-xl">
                            Discover the convenience and sustainability of electric vehicles with SDM E
                            Mobility. Our platform offers seamless access to our own fleet, allowing you to
                        ...
                        {/* <div className="flex items-center text-center flex-col sm:flex-row gap-4 sm:gap-0 mt-8 w-max mx-auto lg:mx-0 ">
                            <div className="flex items-center -space-x-2">
                                <Image src="" height={900} width={1240} alt="avatar" className="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover" />
                                <Image src="" height={900} width={1240} alt="avatar" className="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover" />
                                <Image src="" height={900} width={1240} alt="avatar" className="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover" />
                                <Image src="" height={900} width={1240} alt="avatar" className="w-10 h-10 rounded-full ring-4 ring-white dark:ring-gray-950 object-cover" />
                    ...
                    <div className="lg:h-full hidden md:flex">
                        <div className="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                            ...
                            <div className="absolute w-full h-[80%] z-10 p-1 -translate-y-1/2 top-1/2 right-3 rounded-3xl bg-whitee dark:bg-gray-950  shadow-lg shadow-gray-100 dark:shadow-transparent  border border-gray-200 dark:border-gray-800">
                                <Image src="/hero_ev.png" alt="In studio" width={900} height={900} loading="lazy" className="w-full rounded-2xl object-cover mb-10" />
                            </div>
                            {/* <div className="absolute -translate-y-1/2 top-1/2 h-[calc(80%-2rem)] w-[calc(40%-20px)] p-1 rounded-3xl bg-white dark:bg-gray-950  shadow-lg shadow-gray-100 dark:shadow-transparent  border border-gray-200 dark:border-gray-800">
                                <Image src="/" alt="Happy in studio" width={900} height={900} loading="lazy" className="w-full h-full rounded-2xl object-cover" />
                            </div> */}
                        </div>
                    </div>
                </div>
