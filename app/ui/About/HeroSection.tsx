...
return (
    <>
        <section className="min-h-max bg-white dark:bg-gray-950 relative">
            <div className="absolute top-0 inset-x-0 h-64 flex items-start">
                ...
                <div className="h-20 w-3/5 bg-gradient-to-r from-emerald-500 opacity-40 blur-2xl dark:from-purple-700 dark:opacity-40">
                </div>
            </div>
            ...
            <div className="relative mx-auto pt-32 pb-24 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
                <h1 className="text-gray-900 dark:text-white mx-auto max-w-5xl font-bold text-4xl/tight sm:text-5xl/tight lg:text-6xl/tight xl:text-7xl/tight">
                    SDM e-mobility services pvt.ltd
                </h1>
                ...
                <div className="flex justify-center items-center flex-wrap mx-auto gap-4">
                    <Link href="/booking" className="flex items-center h-12 px-6 rounded-full bg-purple-600 text-white border border-purple-600">
                        Book Now
                    </Link>
                    <Link href="/contact" className="flex items-center h-12 px-6 rounded-full bg-gray-100 dark:bg-gray-900 text-purple-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800">
                        Contact Now
                    </Link>
                </div>
